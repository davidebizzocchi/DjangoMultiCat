...
from cheshire_cat.types.cat_types import UserMessage, LLMRequest
...
class CatMemoryApi(MemoryApi):
    ...
    @validate_call
    def get_conversation_history_length(
        self,
        chat_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_conversation_history_length_serialize(
            chat_id=chat_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_conversation_history_length_serialize(
        self,
        chat_id: str,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/memory/conversation_history/{chat_id}/length',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def insert_message_in_conversation_history(
        self,
        chat_id: StrictStr,
        message: Union[CatMessage, UserMessage],
        index: int,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._insert_message_in_conversation_history_serrialize(
            chat_id=chat_id,
            message=message,
            index=index,
            _request_auth=_request_auth,
    ...
    def _insert_message_in_conversation_history_serrialize(
        self,
        chat_id: str,
        message: Union[CatMessage, UserMessage],
        index: int,
...
class LLMsApi:
    ...
    def _get_llm_serialize(
        ...
        _host = None
        _collection_formats: Dict[str, str] = {}
        _path_params: Dict[str, str] = {'llm_name': llm_name}
        _query_params: List[Tuple[str, str]] = []
        _header_params: Dict[str, Optional[str]] = _headers or {}
        _form_params: List[Tuple[str, str]] = []
        _files: Dict[str, str] = {}
    ...
    def _get_llm_schemas_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def get_llm_schemas(
        ...
        :param _host_index: override host index for request
        :type _host_index: int, optional
        :return: Returns the result object with schemas and return_type
        """
        _param = self._get_llm_schemas_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        )
        _response_types_map = {'200': 'object', '400': 'object'}
        response_data = self.api_client.call_api(*_param, _request_timeout=_request_timeout)
        response_data.read()
        return self.api_client.response_deserialize(response_data=response_data, response_types_map=_response_types_map).data
    ...
    def get_llm(
        ...
        _response_types_map = {'200': 'object', '404': 'object'}
        response_data = self.api_client.call_api(*_param, _request_timeout=_request_timeout)
        response_data.read()
        return self.api_client.response_deserialize(response_data=response_data, response_types_map=_response_types_map).data
